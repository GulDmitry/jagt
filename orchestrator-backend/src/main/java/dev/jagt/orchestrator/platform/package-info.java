 ...
 *
 * <p>Porting jawo to another OS or terminal means implementing three
 * interfaces and wiring them via configuration; the core (git, state, tmux,
 * MCP) never changes:
 *
 * <ul>
 *   <li>{@link dev.jawo.orchestrator.platform.UserNotifier} — OS push
 ...
 *   <li>{@link dev.jawo.orchestrator.platform.TerminalDriver} — how the
 ...
 *   <li>{@link dev.jawo.orchestrator.platform.EditorDriver} — how a worktree
