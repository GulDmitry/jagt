 ...
 * nothing here describes a transport: a channel says which notifications it wants and delivers them.
 *
...
public interface Notifier {
    ...
    /** Whether this channel wants it. Default: everything, which is what a local desktop banner is for. */
