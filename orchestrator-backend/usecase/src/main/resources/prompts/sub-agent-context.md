...
11. A call REFUSED by jagt is not a block: the answer lists every field it objected to and what it expected there. Correct all of them and send the same call again. Never escalate it (rule 1), never work around it by writing the fact somewhere else.
