...
/**
 * A {@code do}, however it arrived. {@code ref} is an issue key or a URL to the item in any tracker;
 * {@code baseBranch} is what to cut from and to target with the review request, null = the project's own.
 */
