...
/**
 * One repository of a task being created, with every fact resolved before anything is cut. {@code primary} says
 * whether the agent's session runs here; the others it edits in place from there.
 */
